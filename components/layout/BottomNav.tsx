...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50">
      <div className="flex items-center gap-1 px-3 py-2 bg-[#111111]/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl shadow-black/50">
        {NAV_ITEMS.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <span className="absolute bottom-2 left-1/2 -translate-x-1/2 w-1 h-1 bg-white rounded-full sm:hidden" />
              )}
            </Link>
          )
        })}
